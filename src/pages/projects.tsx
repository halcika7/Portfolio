...
const Projects: FC = (): JSX.Element => {
  ...
  const [react, setReact] = useState<Project[]>([
    ...
    },
    {
      ...
      title: 'React To-Do',
      frontend: ['React, CSS3'],
      github: 'https://github.com/halcika7/react-todo-app',
      url: '',
    ...
    },
    {
      ...
      github: 'https://github.com/halcika7/react-starter',
      url: '',
      img: data.react.childImageSharp.fluid,
      type: 'front',
      scale: true,
    },
    {
      ...
      frontend: ['Gatsby JS', 'React', 'Typescript', 'SCSS', 'ESLint'],
      github: 'https://github.com/halcika7/gatsby-starter',
      url: '',
      img: data.gatsby.childImageSharp.fluid,
      type: 'front',
      scale: true,
    },
  ]);
